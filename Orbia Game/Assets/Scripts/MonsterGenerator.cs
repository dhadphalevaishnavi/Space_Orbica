...
public class MonsterGenerator : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            if ((level.GetComponent<LevelGenerator>().numberOfOrbits == 2) || ((level.GetComponent<LevelGenerator>().numberOfOrbits == 1) && (level.GetComponent<LevelGenerator>().whichOrbitToDraw == 1)))
            {
                ...
                for (int i = 1; i <= 5; i++)
                {
                    ...
                    monsterPrefabList.Add(monster);                                     // List for Monster formation
